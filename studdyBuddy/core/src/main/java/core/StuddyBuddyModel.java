...
public class StuddyBuddyModel implements Iterable<AbstractStuddyBuddy> {

    private Map<String, AbstractStuddyBuddy> studdyBuddies = new LinkedHashMap<>();

    @Override
    public String toString() {
        return String.format("[StuddyBuddyModel #studdyBuddies=%s]", studdyBuddies.size());
    }

    /**
    * Checks if this StuddyBuddyModel already has a StuddyBuddy with the provided name.
    *
    ...
    */
    ...
    /**
    * Adds the StuddyBuddy to this StuddyBuddyModel.
    *
